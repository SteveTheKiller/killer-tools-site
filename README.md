...
- **Email Header Parser** — paste raw headers to trace delivery hops and view auth results
...
- **Outlook SafeLink Decoder** — unwrap Microsoft Defender SafeLinks to reveal the original URL
- **M365 License SKU Decoder** — decode Microsoft 365 license SKU strings and GUIDs to product names
- **PowerShell Builder** — pick a cmdlet, fill in parameters, copy the finished command
